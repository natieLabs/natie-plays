...
$(function() {
    ...
    var logoHTML = '<div class="ui large secondary menu"> <a class="ui image item" href="http://natie.com"><img src="/logo.png" class="logo"></img> </a> <div class="right menu"> <div class="ui item"> <h5>NATIE/LABS/PLAY</h5></div> </div> </div>'
